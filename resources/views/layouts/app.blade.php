...
<head>
    ...
    <title>{{ config('app.name', 'Trabalho 2') }}</title>
...
<body>
    <div id="app">
        @unless(Request::route()->getName() === 'products.create') <!-- Exclui a navbar apenas na página de criar produto -->
            <nav class="navbar navbar-expand-md navbar-dark bg-primary shadow-sm">
                <div class="container">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        {{ config('app.name', 'Trabalho 2') }}
                    </a>
